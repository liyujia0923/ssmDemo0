...
<script type="text/javascript">
    $(function () {
        ...
        $("#deleteStudentByIdsButton").click(function () {
            var studentId = "";
            $.each($("input[name=deleteStudentCheckBox]"),function (data) {
                if(this.checked){
        ...
        //添加
        $("#saveAddStudentButtonModal").click(function () {
        ...
        $("button[name=queryStudentButton]").click(function () {
            ...
            $.get("${pageContext.request.contextPath}/student/queryStudentById",
                {"id":studentId},function (data) {
                    ...
                    $("#queryGradeName").val(data.grade4.gradeName);
                });
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${pageInfo.list}" var="student">
                    <tr>
                        ...
                        <td>${student.grade4.gradeName}</td>
                        <td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="addStudentForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="grade4.id" id="addStudentSelect">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="saveAddStudentButtonModal">保存</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="queryStudentForm">
                        ...
                        <div class="form-group">
                            <label  class="col-sm-3 control-label">性别</label>
                            <div class="col-sm-8">
                                <input type="text" name="gender" id="queryGender" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-sm-3 control-label">班级</label>
                            <div class="col-sm-8">
                                <input type="text" name="grade4.id" id="queryGradeName"/>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="updateStudentForm">
                        ...
                        <div class="form-group">
                            <label  class="col-sm-3 control-label">班级</label>
                            <div class="col-sm-8">
                                <select class="form-control" name="grade4.id" id="updateStudentSelect">
                                </select>
                            </div>
                        </div>
