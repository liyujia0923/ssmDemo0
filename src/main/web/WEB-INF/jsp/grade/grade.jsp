...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //添加班级
            $("#addGradeByIdsButton").click(function () {
                $("#addGradeModel").modal("show");
            })
            $("#savaAddGradeModelButton").click(function () {
                var grades=$("#addGradeForm").serialize();
                $.post("${pageContext.request.contextPath}/grade/addGrade",grades,
                function (data) {
                    alert(data.msg);
            ...
            //修改班级
            $("button[name=updateGradeById]").click(function () {
                var gradeId = $(this).attr("gradeId");
                $.get("${pageContext.request.contextPath}/grade/queryGradeById",{"gradeId":gradeId},
                    function (data) {
                        $("#updateGradeName").val(data.gradeName);
                        $("#updateId").val(data.id);
                        $("#updateDetails").html(data.details);
                    });

                $("#updateGradeModel").modal("show");
            })
            $("#savaUpdateGradeModelButton").click(function () {
                var grades = $("#updateGradeForm").serialize();
                $.post("${pageContext.request.contextPath}/grade/updateGrade",grades,
                function (data) {
                    alert(data.msg);
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2 col-lg-offset-2">
                ...
                <button class="btn btn-danger" id="addGradeByIdsButton">添加</button>
            </div>
                    ...
                    <c:forEach items="${pageInfo.list}" var="grade">
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-info" name="updateGradeById" gradeId="${grade.id}">修改</button>
